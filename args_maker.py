...
elif os.path.exists('/workspace') and username == 'root':
    # Docker container environment
    os.environ["WANDB_DIR"] = "/workspace/logs/wandb"
    masterkey_root = '/workspace/Datasets/MasterKey'
    dataset_root = '/workspace/Datasets/All'
    results_root = '/workspace/Results'
    default_repo = '/workspace'
    print('User root (Docker container)')
else:
